...
function App() {
  ...
  const apiURL = `https://api.weatherapi.com/v1/current.json?key=e74e7448335545958e093916240803&q=${city}&aqi=no`
  useEffect(()=>{
  fetch(apiURL)
  .then((response)=>{
    if(!response.ok){
  ...
  return (
    <div  className="bg-[#34435E] h-screen flex justify-center align-top">
